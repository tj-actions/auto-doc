...
| col\_max\_words  | string |  false   |     `"6"`      |                 Max number of words per<br>line in a column<br>                 |
| input\_columns  | string |  false   |                | List of Input columns names<br>to display, default (display all<br>columns)<br> |
|     output     | string |  false   | `"README.md"`  |                           Path to the output file<br>                           |
| output\_columns | string |  false   |                | List of Output column names<br>to display, default (display all<br>columns)<br> |
